...
# Translation map from JP to VI
# Using the ja.json keys (JP text) as source
translations = {
    # Title
    "これから大雨が降りますから！": "Sắp Có Mưa Lớn Rồi Đó!",
    
    # Message lines - using JP as key, VI as translation
    "おおぉ……？　事務仕事が予定よりも早く終わった？<br>アリシア、終わっているよな？": "Ôi...? Việc văn phòng xong sớm hơn dự kiến à?<br>Alicia, em đã xong rồi chứ?",
    
    "はい！　終わっていますとも！<br>たくさん頑張っていただけて、わたしも嬉しいですっ！！": "Vâng! Em đã xong rồi ạ!<br>Thấy anh 노력 nhiều như vậy, em cũng vui lắm!!",
    ...
    "天気なんて気まぐれなものだからな。<br>いちいち気にしていたら、外出なんてできなくなる。": "Thời tiết vốn dîle lừng lču. Nếu chi tiết lo lắng thì không ra ngoài được đâu.",
    ...
    "私たちの龍神さまをあんな火吹きトカゲもどきと一緒にするだなんてー！<br>不敬です！　不敬極まりない！": "Đưa Thần Long của chúng ta ra ngang ngửa với loài thằn lằn phun lửa giả tạo kia!<Bất kính! Bất kính tới cực điểm!",
    ...
    "しかもすごい大雨だな！？<br>急いで建物に入れ！　風邪を引くぞ！": "Mưa to lắm!?<br>Nhanh vào nhà! Sẽ 감기 (ốm) đấy!",
...
print("Translation map built:", len(translations), "entries")