...
VI = {
    # Title (JP text in EN asset -> VI Title Case)
    ...
    "After a string of such failures，I was eventually told I was a failure as<br>a soldier，and they stopped giving me any tasks...<br> ": "Thất bại liên tục, cuối cùng bị nói là binh sĩ thất bại, không giao việc gì nữa...<br> ",
    ...
    "Even a dull pebble buried in the earth for years can shine like a<br>beautiful g...<br> ": "Viên sỏi nhòe chôn dưới đất nhiều năm, mài kỹ kiên nhẫn cũng sáng đẹp như ngọc báu!<br> ",
    "Speaking of stones，I'm sure there are all sorts of stones in the<br>Abyss that ...<br> ": "Nói đến đá, chắc trong Đại Huyệt có đủ loại đá mặt đất không thấy!<br> ",
    "Yeah. I wonder what kind of stones are in the Abyss...<br> ": "Ừ. Đại Huyệt có đá gì nhỉ...<br> ",
    "............<br> ": "............<br> ",
    "W-wah!? I-I'm sorry，I got carried away all by myself! In front of the Lord<br>Comma...<br> ": "Ủa wa!? L-lỗi, em tự Say một mình! Trước mặt Chỉ Huy...<br> ",
    ...
    "R-right, I can't be moping around! I have to work hard again<br>starting to...<br> ": "Đ-đúng, không thể chán nản! Ngày mai phải nỗ lực lại!<br> ",
...
# Count entries
print(f"VI dictionary has {len(VI)} entries")

# Verify all keys are unique
assert len(VI) == len(set(VI.keys())), "Duplicate keys!"
print("All keys unique: OK")

# Print first few
for i, (k, v) in enumerate(VI.items()):
    if i < 5:
        print(f"  '{k[:50]}...' -> '{v[:50]}...'")
    else:
        break